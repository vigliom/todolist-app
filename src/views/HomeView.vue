<template>
  <v-container fluid class="pa-0">
    <v-col cols="12">
      <v-date-picker view-mode="month" :landscape="true" show-adjacent-months hide-weekdays hide-header hide-days class="w-100" header="Selecciona un dia" title="AppName"/>
    </v-col>
    <v-col cols="12">
      <v-list>
        <my-item-task
